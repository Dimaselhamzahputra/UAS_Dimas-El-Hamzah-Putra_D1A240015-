...
<!-- Sidebar -->
<aside class="w-1/4 bg-blue rounded shadow p-4">
...
class="bg-purple-600 text-white px-4 py-2 rounded hover:bg-blue-700
...
<!-- Footer -->
<footer class="bg-purple-800 text-white text-center py-4 mt-10">
